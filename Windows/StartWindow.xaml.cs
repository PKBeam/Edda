        ...
        private void CreateRecentMapItem(string name, string path) {
            ...
            */
            ...
            item.MouseRightButtonUp += new MouseButtonEventHandler((sender, e) => { 
                var res = MessageBox.Show("Are you sure you want to remove this map from your recently opened maps list?", "Confirm Removal", MessageBoxButton.YesNoCancel, MessageBoxImage.Warning);
